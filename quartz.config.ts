        ...
        theme: {
            ...
            colors: {
                lightMode: {
                    ...
                    dark: process.env.LIGHT_MODE_DARK ?? "#565980",
                    secondary: process.env.LIGHT_MODE_SECONDARY ?? "#597384",
                    tertiary: process.env.LIGHT_MODE_TERTIARY ?? "#84a59d",
                    highlight: process.env.LIGHT_MODE_HIGHLIGHT ?? "rgba(143, 159, 169, 0.15)",
                    textHighlight: process.env.LIGHT_MODE_TEXT_HIGHLIGHT ??"#af02ff",
                },
                darkMode: {
                    light: process.env.DARK_MODE_LIGHT ?? "#15191d",
                    ...
                    textHighlight: process.env.DARK_MODE_TEXT_HIGHLIGHT ?? "#4a9a82",
                },
            },
        },
    },
